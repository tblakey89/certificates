(function() {
  ...
  function credentialFormTemplate($templateCache) {
    $templateCache.put('add-credential-form.html',
      `
        <div class="jumbotron credential-form" ng-form="$ctrl.addCredentialForm">
          ...
          <p><a class="btn btn-primary btn-lg float-right" role="button" ng-click="$ctrl.verify()">Verify</a></p>
        </div>
      `
    )
  }
